...
# Start the Robot
Ping the bot to check if the connection to the LMS100 was established successfully
$ ping 192.168.0.51
...
Execute the joystick launch file (separate terminal)
...
Plot the odometry and AMCL-supported path with Gnuplot using a launch file (saved in my_first_project as multi.png)
$ gnuplot multi.gp
